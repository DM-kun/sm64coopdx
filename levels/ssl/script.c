...
const LevelScript level_ssl_entry[] = {
    ...
    AREA(/*index*/ 1, ssl_geo_000648),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -1200,   500,   800, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_SSL*10 + 1), /*beh*/ bhvExclamationBox),
    ...
    AREA(/*index*/ 2, ssl_geo_0007CC),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -3536,   252, -3705, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_SSL*10 + 2), /*beh*/ bhvExclamationBox),
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -1242,   252, -3957, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_SSL*10 + 3), /*beh*/ bhvExclamationBox),
