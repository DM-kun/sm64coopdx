...
const LevelScript level_thi_entry[] = {
    ...
    AREA(/*index*/ 1, thi_geo_000608),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -5712, -2190,  1100, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_THI*10 + 2), /*beh*/ bhvExclamationBox),
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ 6022, -1722,  -633, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_THI*10 + 3), /*beh*/ bhvExclamationBox),
    ...
    AREA(/*index*/ 2, thi_geo_0006D4),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -1866,  -400,   311, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_THI*10 + 1), /*beh*/ bhvExclamationBox),
        SET_BACKGROUND_MUSIC(/*settingsPreset*/ 0x0000, /*seq*/ SEQ_LEVEL_GRASS),
        TERRAIN_TYPE(/*terrainType*/ TERRAIN_GRASS),
    END_AREA(),
