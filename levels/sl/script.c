...
const LevelScript level_sl_entry[] = {
    ...
    AREA(/*index*/ 1, sl_geo_0003A8),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -3380,  1360, -4140, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_SL*10 + 1), /*beh*/ bhvExclamationBox),
    ...
    AREA(/*index*/ 2, sl_geo_000484),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -120,   300, -1740, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_SL*10 + 2), /*beh*/ bhvExclamationBox),
