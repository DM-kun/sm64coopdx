...
const LevelScript level_ccm_entry[] = {
    ...
    AREA(/*index*/ 1, ccm_geo_00051C),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -4887, -1300, -4003, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_CCM*10 + 1), /*beh*/ bhvExclamationBox),
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -1557,  -205,  1794, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_CCM*10 + 2), /*beh*/ bhvExclamationBox),
    ...
    AREA(/*index*/ 2, ccm_geo_0005E8),
        ...
        OBJECT(/*model*/ MODEL_EXCLAMATION_BOX, /*pos*/ -5600, -4500, -6644, /*angle*/ 0, 0, 0, /*behParam*/ (0x14040000 + LEVEL_CCM*10 + 3), /*beh*/ bhvExclamationBox),
