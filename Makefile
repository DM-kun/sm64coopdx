...
all:
    ...
    install_name_tool -change $(BREW_PREFIX)/lib/libSDL3-3.4.10.dylib @executable_path/libSDL3.dylib $(APP_MACOS_DIR)/sm64coopdx > /dev/null 2>&1; \
    install_name_tool -change $(BREW_PREFIX)/opt/sdl3/lib/libSDL3-3.4.10.dylib @executable_path/libSDL3.dylib $(APP_MACOS_DIR)/sm64coopdx > /dev/null 2>&1; \
