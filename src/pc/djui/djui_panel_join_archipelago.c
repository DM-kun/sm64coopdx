...
static struct DjuiInputbox* sInputboxName = NULL;
static struct DjuiInputbox* sInputboxPass = NULL;
static struct DjuiInputbox* sInputboxFile = NULL;
...
void djui_panel_join_direct_create(struct DjuiBase* caller) {
    ...
    {
        struct DjuiText* text1 = djui_text_create(body, DLANG(ARCHIPELAGO, AP_JOIN));
        ...
        struct DjuiText* text2 = djui_text_create(body, DLANG(ARCHIPELAGO, AP_NAME));
        ...
        djui_interactable_hook_value_change(&inputbox2->base, djui_panel_join_direct_ip_text_change);
        sInputboxName = inputbox2;
        djui_panel_join_direct_ip_text_set(inputbox2);

        struct DjuiText* text3 = djui_text_create(body, DLANG(ARCHIPELAGO, AP_PASS));
        djui_base_set_size_type(&text3->base, DJUI_SVT_RELATIVE, DJUI_SVT_ABSOLUTE);
        djui_base_set_size(&text3->base, 1.0f, 100);
        djui_base_compute_tree(&text3->base);
        u16 directLines = djui_text_count_lines(text3, 12);
        f32 directTextHeight = 32 * 0.8125f * directLines + 8;
        djui_base_set_size(&text3->base, 1.0f, directTextHeight);
        djui_base_set_color(&text3->base, 220, 220, 220, 255);

        struct DjuiInputbox* inputbox3 = djui_inputbox_create(body, 256);
        djui_base_set_size_type(&inputbox3->base, DJUI_SVT_RELATIVE, DJUI_SVT_ABSOLUTE);
        djui_base_set_size(&inputbox3->base, 1.0f, 32.0f);
        djui_interactable_hook_value_change(&inputbox3->base, djui_panel_join_direct_ip_text_change);
        sInputboxPass = inputbox3;
        djui_panel_join_direct_ip_text_set(inputbox3);

        struct DjuiText* text4 = djui_text_create(body, DLANG(ARCHIPELAGO, AP_FILE));
        djui_base_set_size_type(&text4->base, DJUI_SVT_RELATIVE, DJUI_SVT_ABSOLUTE);
        djui_base_set_size(&text4->base, 1.0f, 100);
        djui_base_compute_tree(&text4->base);
        u16 directLines = djui_text_count_lines(text4, 12);
        f32 directTextHeight = 32 * 0.8125f * directLines + 8;
        djui_base_set_size(&text4->base, 1.0f, directTextHeight);
        djui_base_set_color(&text4->base, 220, 220, 220, 255);

        struct DjuiInputbox* inputbox4 = djui_inputbox_create(body, 256);
        djui_base_set_size_type(&inputbox4->base, DJUI_SVT_RELATIVE, DJUI_SVT_ABSOLUTE);
        djui_base_set_size(&inputbox4->base, 1.0f, 32.0f);
        djui_interactable_hook_value_change(&inputbox4->base, djui_panel_join_direct_ip_text_change);
        sInputboxFile = inputbox4;
        djui_panel_join_direct_ip_text_set(inputbox4);
